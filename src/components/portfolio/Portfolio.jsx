    ...
    <section id='portfolio'>
      ...
      <div className="container portfolio__container">
         <article className='portfolio__item'>
          ...
          <h3>This is a sectio of a ite i built</h3>
          <a href="https://githup.com" className='btn'>Github</a>
          <a href="https://githup.com/ntuieaoul1/" className='btn btn-primary' target='_blank'>Live Demo</a>
         </article>
         ...
         <article className='portfolio__item'>
          ...
          <a href="https://githup.com" className='btn'>Github</a>
          <a href="https://githup.com/ntuiraoul1/" className='btn btn-primary' target='_blank'>Live Demo</a>
         </article>
         ...
         <article className='portfolio__item'>
          ...
          <h3>One of my best work</h3>
          <a href="https://githup.com" className='btn'>Github</a>
          <a href="https://githup.com/ntuiraoul/" className='btn btn-primary' target='_blank'>Live Demo</a>
         </article>
